...
class InputParameters:
    ...
    def from_desktop_file(base_path:str = None):
        ...
        entrypoint = os.path.abspath(os.path.join(base_path, desktop.data["AppImage Creator"]["Entrypoint"]))
        icon = os.path.abspath(os.path.join(base_path, desktop.data["AppImage Creator"]["Icon"]))
